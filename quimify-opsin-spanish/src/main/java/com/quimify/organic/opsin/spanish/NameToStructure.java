...
import com.quimify.organic.opsin.spanish.OpsinResult.OPSIN_RESULT_STATUS;
...
public class NameToStructure {
	...
	private NameToStructure() {
		...
		try {
			...
			ResourceGetter resourceGetter = new ResourceGetter("com/quimify/organic/opsin/spanish/resources/");
